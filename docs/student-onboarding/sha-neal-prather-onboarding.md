# ARIA Student Onboarding Guide — Sha Neal Prather
...
| Linux Container | `student-linux-01` |
| Linux Tailscale IP | `100.76.81.39` |
...
|---|---|---|
| Windows / Active Directory | `student01` | ______________________________ |
| Zammad Help Desk | `student01` | ______________________________ |
| ARIA AI Mentor | `student01` | ______________________________ |
| Linux Container | `student01` | ______________________________ |
...
```text
whoami should show student01
hostname should show student-linux-01
...
[ ] I know my ARIA student ID: student01.
[ ] I can log into Zammad.
[ ] I can access the ARIA AI Mentor student page.
[ ] I can SSH into student-linux-01.
